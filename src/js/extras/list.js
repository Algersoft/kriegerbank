...
module.exports = function(id, options, values) {
  ...
  init = {
    start: function() {
      ...
      self.search = __webpack_require__(16)(self);
      self.filter = __webpack_require__(17)(self);
      self.sort = __webpack_require__(18)(self);
...
var Templater = function(list) {
  var deleteChildren = __webpack_require__(15),
    templater = this,
    createItem;
  ...
  var init = function() {
    ...
    itemSource = itemSource.outerHTML;
  ...
  var createCleanTemplateItem = function(templateNode, valueNames) {
    ...
    for (var i = 0, il = valueNames.length; i < il; i++) {
      var elm, valueName = valueNames[i];
      if (valueName.data) {
  ...
  this.create = function(item) {
    ...
    var itemHTML = createItem(item.values());
    item.elm = getItemSource(itemHTML);
...
var deleteRange = function(node) {
  var range = document.createRange();
  range.selectNodeContents(node);
  range.deleteContents();
};

var fallback = function(node){
...
module.exports = function(list) {
  var item, text, columns, searchPattern, customSearch, rawTerm;
  ...
  var prepare = {
    ...
    setColumns: function() {
      ...
      if (columns === undefined) {
        columns =
          list.searchColumns === undefined ? prepare.toArray(list.items[0].values()) : list.searchColumns;
      }
    },
    setSearchPattern: function(s) {
      s = list.utils.toString(s);
      if (s === "") {
  ...
  var search = {
    ...
    values: function(values, column) {
      if (values.hasOwnProperty(column)) {
        ...
        if(rawTerm){
            if(text.indexOf(rawTerm) !== -1) return true;
        }

        return searchPattern && searchPattern.test(text);
      }
      return false;
    },
    reset: function() {
