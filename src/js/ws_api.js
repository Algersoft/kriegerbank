...
class WalletShellApi {
    constructor(args) {
        ...
        this.service_password = args.service_password || "squirrelpenis";
    ...
    // only get single address only, no multi address support for this wallet, yet
    getAddress() {
        return new Promise((resolve, reject) => {
    ...
    sendTransaction(params) {
        return new Promise((resolve, reject) => {
            ...
            if (parseFloat(params.fee) < 0.1) return reject(new Error('Minimum fee is 0.1 KREGR'));
            //[{address: "KREGRxxxx...", amount: 100}];
            var req_params = {
